...
//CodeTop
const htmlTop = document.getElementById('htmlTop');
const cssTop = document.getElementById('cssTop');
const jsTop = document.getElementById('jsTop');
//CodeTools
const ToolBtn = document.get
const htmlTools = document.getElementById('htmltools');
const cssTools = document.getElementById('csstools');
const jsTools = document.getElementById('jstools');

htmlTop.addEventListener("click", function(){
    //Changing Top color
    htmlTop.classList.add("logoselect");
    cssTop.classList.remove("logoselect");
    jsTop.classList.remove("logoselect");
    //Changing the code area Appearing
    htmlCode.style.display = "block"
    cssCode.style.display ="none"
    jsCode.style.display ="none"
    //Changing the Tools Section
    htmlTools.style.display = "flex"
    cssTools.style.display ="none"
    jsTools.style.display ="none"
})

cssTop.addEventListener("click", function(){
    //Changing Top color
    htmlTop.classList.remove("logoselect");
    cssTop.classList.add("logoselect");
    jsTop.classList.remove("logoselect");
    //Changing the code area Appearing
    ...
    cssTools.style.display = "flex"
    jsTools.style.display ="none"
})

jsTop.addEventListener("click", function(){
    //Changing Top color
    htmlTop.classList.remove("logoselect");
    cssTop.classList.remove("logoselect");
    jsTop.classList.add("logoselect");
    //Changing the code area Appearing
    htmlCode.style.display ="none"
    cssCode.style.display ="none"
    jsCode.style.display ="flex"
    //Changing the Tools Section
    htmlTools.style.display ="none"
    cssTools.style.display ="none"
    jsTools.style.display = "flex"
})
